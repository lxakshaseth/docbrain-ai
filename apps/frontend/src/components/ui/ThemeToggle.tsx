  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative group p-2 rounded-xl bg-slate-900/80 hover:bg-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800 border border-slate-800 dark:border-slate-800 text-slate-300 dark:text-slate-200 hover:text-white transition-all duration-300 shadow-sm flex items-center justify-center overflow-hidden focus:outline-none focus:ring-2 focus:ring-blue-500/50"
      >
