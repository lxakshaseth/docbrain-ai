              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={user.email}
                    disabled
                    className="w-full bg-slate-950/60 border border-slate-800/80 rounded-xl pl-9 pr-3 py-2 text-xs text-slate-400 cursor-not-allowed opacity-80"
                  />
                </div>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-slate-800/40 border border-slate-800 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs font-medium text-slate-200">AI Response Quality</p>
                    <p className="text-[10px] text-slate-400">Detailed RAG context and citation source breakdown</p>
                  </div>
                  <span className="text-xs font-semibold text-blue-400">High Precision</span>
                </div>
              </div>
              ...
              <div className="p-3 bg-slate-800/40 border border-slate-800 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs font-medium text-slate-200">Chat Auto-Scroll</p>
                    <p className="text-[10px] text-slate-400">Automatically scroll down on streaming AI answers</p>
                  </div>
