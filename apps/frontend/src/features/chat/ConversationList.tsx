...
export const ConversationList: React.FC = () => {
  ...
  return (
    <div className="space-y-2 mt-4 pt-4 border-t border-slate-800/80">
      <h4 className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider px-1 flex items-center gap-1.5">
        <Clock className="w-3.5 h-3.5 text-indigo-400" /> Recent Sessions ({conversations.length})
      </h4>
